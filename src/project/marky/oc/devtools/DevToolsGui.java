package project.marky.oc.devtools;
 ...
 */
public class DevToolsGui
{
	private static DevToolsGui GUI;
	...
	private final JFrame _frame = new JFrame("Marky's Clonk Development Tools");
	...
	private void loadSpecificProject(final File file)
	{
	...
	private void saveSpecificProject(final File file)
	{
